# looking at confusion matrix using a logistic regression model using the Heyer character dataset
# import libraries
import pandas as pd
import pdb
import argparse
...
parser = argparse.ArgumentParser("Code to create a confusion matrix using a binary logistic regression model")
