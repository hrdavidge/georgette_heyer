# testing confusion matrix with a random forest classification using the Georgette Heyer survey dataset
# import libraries
import pandas as pd
import pdb
import argparse
...
parser = argparse.ArgumentParser("Code to test confusion matrix with a random forest classifcation model")
