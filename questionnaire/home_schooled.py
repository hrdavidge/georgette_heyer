...
df.loc[df['mainstream'] == 1, ['mainstream']] = 'Had a Mainstream Education'
df.loc[df['mainstream'] == 0, ['mainstream']] = 'Did not have a Mainstream Education'
...
# save csv of df of people who did not have a mainstream education
home_schooled_df = df.loc[df['mainstream'] == 'Did not have a Mainstream Education']
home_schooled_df.to_csv(os.path.join(save_path + 'df_home_schooled.csv'), index=False)
